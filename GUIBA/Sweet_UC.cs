...
namespace GUIBA
{
    public partial class Sweet_UC : UserControl
    {
        int index;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Invalid sweetname! Please enter a valid name:");
        ...
        private void Sweet_UC_Load(object sender, EventArgs e)
        {
            try
            {
                table = new DataTable(); // Initialize the DataTable if necessary
                table.Columns.Add(" Sweet name", typeof(string));
                table.Columns.Add(" Sweet Category", typeof(string));
                table.Columns.Add(" Sweet price", typeof(string));
